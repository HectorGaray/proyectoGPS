   ...
   int fila;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       ManejadorPresidencia autoriza= new ManejadorPresidencia();
        ...
        if(input==0){
            if(autoriza.atualizaEstadoSolicitud(autoriza.idSolicitud(tablaS.getValueAt(fila, 7).toString()),0)){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int input = JOptionPane.showConfirmDialog(this,"Esta seguro de NO AUTORIZAR esta solicitud","Confirmar",JOptionPane.YES_NO_CANCEL_OPTION);
        if(input==0){
            if(autoriza.atualizaEstadoSolicitud(autoriza.idSolicitud(tablaS.getValueAt(fila, 7).toString()),1)){
