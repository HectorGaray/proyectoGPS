...
ManejadorAdministracion ad= new ManejadorAdministracion();
 int input = JOptionPane.showConfirmDialog(this,"Esta seguro de asignar un monto"+monto.getText()+"Con el vehiculo"+tabla.getValueAt(fila, 0),"Confirmar operacion",JOptionPane.YES_NO_CANCEL_OPTION);
        if(input==0){
            String a=ad.idVehiculo(tabla.getValueAt(fila, 0).toString());
           if(ad.ViaticoHacer(monto.getText(),a,codigo.getText(), tipo)){
               
               if(ad.atualizaEstadoSolicitud(tabla.getValueAt(fila, 0).toString())){
